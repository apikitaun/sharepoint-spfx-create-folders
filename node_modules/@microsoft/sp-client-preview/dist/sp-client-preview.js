define("4d5eb168-6729-49a8-aec7-0e397f486b6e_1.4.0", ["@microsoft/sp-core-library","@microsoft/sp-lodash-subset","@ms/sp-telemetry","@microsoft/sp-http"], (function(__WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_7__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var MSGraphClient_1 = __webpack_require__(1);
exports.MSGraphClient = MSGraphClient_1.default;
...
var sp_http_1 = __webpack_require__(7);
var MSGraphClient = (function () {
    function MSGraphClient(serviceScope) {
        var _this = this;
        serviceScope.whenFinished((function () {
            if (!MSGraphClient._instance) {
                _this._configureGraphSDK(serviceScope.consume(sp_http_1.OAuth2TokenProvider.serviceKey));
            }
        }));
    }
    ...
    MSGraphClient.prototype._getOAuthToken = function (tokenProvider) {
        if (!this._getOAuth2TokenPromise) {
            this._getOAuth2TokenPromise = new Promise(function (resolve, reject) {
                ...
                return tokenProvider.getOAuthToken(sp_http_1._GraphConstants.PROD_OAUTH_TOKEN_URL)
