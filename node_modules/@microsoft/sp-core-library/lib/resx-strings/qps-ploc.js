define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      ...
      "isNullValidateError": "[!!--##***Ŧħȅ vãŀůę ƒŏŕ \"{0}\" mųŝŧ ņōŧ Ƅē ŉűľŀ##--!!]",
      "isUndefinedValidateError": "[!!--##***Ŧħȇ vȃŀůȇ ƒőŗ \"{0}\" mūśť ŉőŧ ƀȇ űńďȅƒıņȇď##--!!]",
      "isEmptyStringValidateError": "[!!--##***Ŧĥȇ váľũȅ ƒōř \"{0}\" mųśţ ŉōţ ɓȇ ąƞ ēmƥţȳ šťŗĭņğ##--!!]",
      ...
      "serviceScopeConsumingBeforeFinished": "[!!--##***Ćãňƞơť ćőŋśũmė ŝěŗvĭċĕŝ Ƃȅċâũşě ţħě şćŏƿē ıŝ ňơť ƒıŉīşĥȇď ȳȅť##--!!]",
      "serviceScopeConsumingDuringAutoCreation": "[!!--##***Ċäƞƞōŧ ćőņšųmě šȇŗvıċěš đųřįňġ ŞȇŗvįċěŚĉōƿȅ ăűŧőćŗȇāťĩőŉ##--!!]",
