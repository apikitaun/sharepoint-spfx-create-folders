define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      ...
      "isEmptyStringValidateError": "***Ťħĕ vãľũȅ ƒơŗ \"{0}\" mūśŧ ŉơţ ƀě ąŋ ēmƥŧƴ ŝŧŕĭńĝ",
      ...
      "serviceScopeConsumingDuringAutoCreation": "***Čáŉņōţ čőŉşūmę ŝěřvĭčėŝ đųřĭŋġ ŚēřvĩĉȇŠċơƥė ȁŭŧơċřęąţĩơƞ",
      "serviceScopeAlreadyFinishedError": "***Ťħȇ ŠȅŕvĭćȇŚċŏƿȅ įś āłŗĕȃďŷ ƒĩŉĩšħěď",
      "serviceScopeProvideServiceAfterFinishedError": "***Čăŉņŏţ řęģıšŧěŕ śēŗvĩčė ƀĕčåūśē ŧĥȇ šċŏƿȇ īş ȃļřēäđƴ ƒįňīŝĥęď",
